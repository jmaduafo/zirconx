...
// Query: *[_type == "settings"][0]{    _id,    _type,    socialLinks[]{      platform,      url    },    statistics[]{      title,      statistic    },    faqs[]{      question,      answer    },    navigations[]{      name    },    services[] {      title,      desc,      icon,      details,      note    },    testimonials[]{      client,      text    },    gallery,    home{      hero,      services,      events,      transition1,      transition2,      transition3    },    about{      opening,      transition,      closing    },    events{      opening    },    clients,    address{      street,      city,      country    },    phone,    email,    owner,    logo,    homeServices,    homeEvents,    transition1,    transition2,    transition3,    aboutOpening,    aboutTransition,    aboutMotive,    eventOpening  }
